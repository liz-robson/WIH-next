...
export default function Login() {
    return (
      ...
      <form className="flex flex-col space-x-4 space-y-4 mx-auto" action="/auth/login" method="post">
        ...
        <button className="bg-blue text-white font-bold py-2 px-4 rounded max-w-40">Sign In</button>
        <button className="bg-blue text-white font-bold py-2 px-4 rounded max-w-40" formAction="/auth/sign-up">Sign Up</button>
